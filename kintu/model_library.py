...
MODEL_LIBRARY: dict[str, ModelSpec] = {
    ...
    Model.claude_4_opus_20250514: ModelSpec(
        ...
        pricing=ModelPricing(input_nocache=15.0, output=75.0, input_cache_read=1.5, input_cache_write=18.75),
    ...
    Model.claude_4_sonnet_20250514: ModelSpec(
        ...
        pricing=ModelPricing(input_nocache=3.0, output=15.0, input_cache_read=0.3, input_cache_write=3.75),
        context_window=200_000,
        max_output_tokens=4_096,
        temperature_range=(0.0, 1.0),
        release_date="2025-05-14",
    ...
    Model.claude_3_5_haiku_20241022: ModelSpec(
        ...
        pricing=ModelPricing(input_nocache=0.8, output=4.0, input_cache_read=0.08, input_cache_write=1.0),
        context_window=200_000,
        max_output_tokens=8_192,
        temperature_range=(0.0, 1.0),
        release_date="2024-10-22",
    ...
    Model.gpt_4_1: ModelSpec(
        ...
        pricing=ModelPricing(input_nocache=2.0, output=8.0),
    ...
    Model.gpt_4_1_mini: ModelSpec(
        ...
        pricing=ModelPricing(input_nocache=0.4, output=1.6),
        context_window=128_000,
        max_output_tokens=16_384,
        temperature_range=(0.0, 2.0),
        release_date="2025-04-14",
    ...
    Model.gpt_4_1_nano: ModelSpec(
        ...
        pricing=ModelPricing(input_nocache=0.1, output=0.4),
        context_window=128_000,
    ...
    Model.o4_mini: ModelSpec(
        ...
        pricing=ModelPricing(input_nocache=1.1, output=4.4),
        context_window=128_000,
    ...
    Model.gemini_2_5_pro: ModelSpec(
        ...
        pricing=ModelPricing(input_nocache=1.25, output=10.0),
    ...
    Model.gemini_2_5_flash: ModelSpec(
        ...
        pricing=ModelPricing(input_nocache=0.3, output=2.5),
    ...
    Model.llama_4_scout_17b: ModelSpec(
        ...
        pricing=ModelPricing(input_nocache=0.18, output=0.18),
    ...
    Model.qwen3_235b_thinking: ModelSpec(
        ...
        pricing=ModelPricing(input_nocache=12.0, output=12.0),
    ...
    Model.qwq_32b: ModelSpec(
        ...
        pricing=ModelPricing(input_nocache=0.3, output=0.3),
        context_window=32_768,
    ...
    Model.glm_4_5_air: ModelSpec(
        ...
        pricing=ModelPricing(input_nocache=0.0, output=0.0),
        context_window=0,
        max_output_tokens=0,
        temperature_range=(0.0, 2.0),
    ),
    Model.kimi_k2_instruct: ModelSpec(
        ...
        pricing=ModelPricing(input_nocache=0.15, output=0.15),
        context_window=32_768,
        max_output_tokens=8_192,
        temperature_range=(0.0, 2.0),
    ),
